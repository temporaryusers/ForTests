...
namespace Transcript.WebUI.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,SecondName,FirstName,MiddleName,GroupId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,SecondName,FirstName,MiddleName,GroupId")] Student student)
        {
            if (ModelState.IsValid)
            {
