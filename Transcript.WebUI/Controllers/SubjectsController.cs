...
namespace Transcript.WebUI.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Abbreviation,DepartmentId")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Abbreviation,DepartmentId")] Subject subject)
        {
            if (ModelState.IsValid)
            {
